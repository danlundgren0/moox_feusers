...
CREATE TABLE fe_users (	
	...
	password_recovery_tstamp int(10) unsigned NOT NULL DEFAULT '0'
);

#
# Table structure for table 'tx_mooxfeusers_domain_model_template'
#
CREATE TABLE tx_mooxfeusers_domain_model_template (
